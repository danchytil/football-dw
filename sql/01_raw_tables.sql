...
-- Raw financial data from Kaggle dataset (aggregated from player valuations)
CREATE TABLE IF NOT EXISTS raw.kaggle_values (
    id SERIAL PRIMARY KEY,
    run_id UUID NOT NULL,
    season VARCHAR(10) NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_raw_kaggle_run ON raw.kaggle_values(run_id);
